...
const saveManholeCover = (manHoleRepository) => (manHoleObj) => __awaiter(void 0, void 0, void 0, function* () {
    const { radio, material, decoration } = manHoleObj;
    const manHole = manHoleRepository.create(radio, material, decoration);
